        ...
        <div id="tinTuc" className="tinTuc container mb-5">
                <ul className="nav nav-pills mb-3 tinTuc__tieuDe" id="pills-tab" role="tablist">
                    <li className="nav-item" role="presentation">
                        <a className="nav-link active" id="pills-dienAnh-tab" data-bs-toggle="pill" href="#pills-dienAnh" role="tab" aria-controls="pills-dienAnh" aria-selected="true">Điện Ảnh 24h</a>
                    </li>
                    <li className="nav-item" role="presentation">
                        <a className="nav-link" id="pills-review-tab" data-bs-toggle="pill" href="#pills-review" role="tab" aria-controls="pills-review" aria-selected="false">Review</a>
                    </li>
                    <li className="nav-item" role="presentation">
                        <a className="nav-link" id="pills-khuyenMai-tab" data-bs-toggle="pill" href="#pills-khuyenMai" role="tab" aria-controls="pills-khuyenMai" aria-selected="false">Khuyến mãi</a>
                    </li>
                </ul>
